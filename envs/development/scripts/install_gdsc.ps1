...
(new-object System.Net.WebClient).DownloadFile('https://dl.google.com/dirsync/dirsync-win64.exe', "$LocalTempDir\$dirsync")
"$LocalTempDir\$dirsync -q"    

[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::TLS12
$git = "Git-2.26.0-64-bit.exe" 
(New-Object net.webclient).DownloadFile('https://github.com/git-for-windows/git/releases/download/v2.26.0.windows.1/Git-2.26.0-64-bit.exe', "$LocalTempDir\$git")
"$LocalTempDir\$git /VERYSILENT" 
